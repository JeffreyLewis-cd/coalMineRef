...
<template>
    <div class="coalMineInfor-index commonLinks" data-pageindex="1"  :data-link="linkCodeBox.others">
            ...
            <div class="inforSearch-form">
                <div class="inforSearch-form-stable">
                    <div class="inforSearch-form-row">
                        <Row>
                            <Col span="24" class="inforSearch-form-title">其他查询</Col>
                        </Row>
                        <Breadcrumb class="inforSearch-form-breadcrumb">
                            ...
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item" href="/fireInfor">其他事故</Breadcrumb-item>
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item">其他</Breadcrumb-item>
                        </Breadcrumb>
                    </div>
