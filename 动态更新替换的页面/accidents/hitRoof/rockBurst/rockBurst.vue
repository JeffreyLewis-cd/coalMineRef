...
<template>
    <div class="coalMineInfor-index commonLinks" data-pageindex="1"  :data-link="linkCodeBox.rockBurst">
        <!--2.2中间正文-->
            ...
            <div class="inforSearch-form">
                <div class="inforSearch-form-stable">
                    <div class="inforSearch-form-row">
                        <Row>
                            <Col span="24" class="inforSearch-form-title">冲击地压与矿震查询</Col>
                        </Row>
                        <Breadcrumb class="inforSearch-form-breadcrumb">
                            ...
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item" href="/fireInfor">顶板事故</Breadcrumb-item>
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item">冲击地压与矿震</Breadcrumb-item>
                        </Breadcrumb>
                    </div>
