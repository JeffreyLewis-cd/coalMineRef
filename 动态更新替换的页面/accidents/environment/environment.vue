...
<template>
    <div class="coalMineInfor-index commonLinks" data-pageindex="1"  :data-link="linkCodeBox.environment">
            ...
            <div class="inforSearch-form">
                <div class="inforSearch-form-stable">
                    <div class="inforSearch-form-row">
                        <Row>
                            <Col span="24" class="inforSearch-form-title">环境查询</Col>
                        </Row>
                        <Breadcrumb class="inforSearch-form-breadcrumb">
                            ...
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item" href="/fireInfor">环境事故</Breadcrumb-item>
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item">环境</Breadcrumb-item>
                        </Breadcrumb>
                    </div>
