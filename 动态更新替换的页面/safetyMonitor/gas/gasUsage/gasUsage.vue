...
<template>
    <div class="enterpriseInfor-index commonLinks" data-pageindex="1" :data-link="linkCodeBox.gasUsage">
        <!--2.2中间正文-->
            ...
            <div class="inforSearch-form">
                <div class="inforSearch-form-stable">
                    <div class="inforSearch-form-row">
                        <Row>
                            <Col span="24" class="inforSearch-form-title">瓦斯利用查询</Col>
                        </Row>
                        <Breadcrumb class="inforSearch-form-breadcrumb">
                            ...
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item">瓦斯利用</Breadcrumb-item>
                        </Breadcrumb>
                    </div>
