...
<template>
    <div class="enterpriseInfor-index commonLinks" data-pageindex="1" :data-link="linkCodeBox.dustData">
        <!--2.2中间正文-->
            ...
            <div class="inforSearch-form">
                <div class="inforSearch-form-stable">
                    <div class="inforSearch-form-row">
                        <Row>
                            <Col span="24" class="inforSearch-form-title">粉尘物性检测数据查询</Col>
                        </Row>
                        <Breadcrumb class="inforSearch-form-breadcrumb">
                            <span>当前位置：</span>
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item" href="/dustData">安全监测</Breadcrumb-item>
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item" href="/dustData">防尘</Breadcrumb-item>
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item">粉尘物性检测数据</Breadcrumb-item>
                        </Breadcrumb>
                    </div>
