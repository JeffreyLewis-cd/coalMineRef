...
<template>
    <div class="enterpriseInfor-index commonLinks" data-pageindex="1"  :data-link="linkCodeBox.fireSealCheck">
        <!--2.2中间正文-->
            ...
            <div class="inforSearch-form">
                <div class="inforSearch-form-stable">
                    <div class="inforSearch-form-row">
                        <Row>
                            <Col span="24" class="inforSearch-form-title">防火密闭检查台账查询</Col>
                        </Row>
                        <Breadcrumb class="inforSearch-form-breadcrumb">
                            ...
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item">防火密闭检查台账</Breadcrumb-item>
                        </Breadcrumb>
                    </div>
