...
<template>
    <div class="enterpriseInfor-index commonLinks" data-pageindex="1" :data-link="linkCodeBox.enterpriseInfor">
        <!--2.2中间正文-->
            ...
            <div class="inforSearch-form">
                <div class="inforSearch-form-stable">
                    <div class="inforSearch-form-row">
                        <Row>
                            <Col span="24" class="inforSearch-form-title">企业信息查询</Col>
                        </Row>
                        <Breadcrumb class="inforSearch-form-breadcrumb">
                            ...
                            <Breadcrumb-item class="inforSearch-form-breadcrumb-item">企业信息</Breadcrumb-item>
                        </Breadcrumb>
                    </div>
...
<script>
    ...
    export default{
        ...
        mounted: function(){
            //初始化 列表数组容器
//            let listDataItems=this.condiContainerx[5];
